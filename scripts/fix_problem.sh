...
[ -e "./package/extpackages/luci-app-tailscale/root/usr/share/luci/menu.d/luci-app-tailscale.json" ] && sed -i 's/services/vpn/g' package/extpackages/luci-app-tailscale/root/usr/share/luci/menu.d/luci-app-tailscale.json
echo "Tailscale完成"
# 固定Vermagic
